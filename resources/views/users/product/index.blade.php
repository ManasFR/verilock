...
<div class="d-flex justify-content-between mb-4">
    ...
    <a href="{{ route('userproducts') }}" class="btn btn-success" style="width: 20%"><i class="fas fa-box"></i> Create Product</a>
</div>
...
@else
    ...
    <button id="deleteSelectedBtn" class="btn btn-danger" style="display: none;"><i class="fas fa-trash"></i> Delete Selected</button>
@endif
