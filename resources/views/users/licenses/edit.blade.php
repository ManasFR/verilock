...
<div class="container mt-5">
    ...
    <form action="{{ route('user.licenses.update', $license->id) }}" method="POST">
        @csrf
        @method('PUT')
    ...
    <textarea name="license_codes" id="license-codes" class="form-control" rows="10" style="resize: vertical;" required>{{ str_replace(', ', ",\n", $license->license_codes) }}</textarea>
</div>
