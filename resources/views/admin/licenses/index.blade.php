...
<div class="container mt-5">
    ...
    <div class="text-end mb-4">
        ...
        <a href="{{ route('licenses.create') }}" class="btn btn-primary" style="width: 20%"><i class="fas fa-key"></i> Create Licenses</a>
    </div>
                    ...
                    <td>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <a href="{{ route('admin.licenses.edit', $license->id) }}" class="btn mx-2" style="background-color: #ffc107; color: #212529; flex-fill me-2; width:50%">
                                    <i class="fas fa-edit"></i> Edit
                                </a>
                                <form action="{{ route('licenses.destroy', $license->id) }}" method="POST" class="flex-fill">
                                    @csrf
                                    @method('DELETE')
